...
### U-Net: A simple and effective architecture widely used in biomedical image segmentation tasks.
### Attention U-Net: Incorporates attention mechanisms to selectively focus on relevant features and ignore irrelevant ones, potentially improving segmentation accuracy.
### Res U-Net: Combines U-Net architecture with residual learning, addressing the vanishing gradient problem and allowing for deeper networks.
### U-Net++: Introduces nested and dense connections between the contracting and expanding paths, refining segmentation masks at multiple resolutions and improving gradient flow during training.
